...
/**
 * EmployeeSkillsFixture
 *
 */
class EmployeeSkillsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_employee_id_skills' => ['type' => 'index', 'columns' => ['employee_id'], 'length' => []],
            'fk_employee_skill_id' => ['type' => 'index', 'columns' => ['skill_id'], 'length' => []],
            'fk_employee_skill_level' => ['type' => 'index', 'columns' => ['skill_level_id'], 'length' => []],
            'fk_employee_updated_id' => ['type' => 'index', 'columns' => ['updated_by'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-07-22 11:34:49',
                'modified' => '2020-07-22 11:34:49'
            ],
        ];
        parent::init();
    }
