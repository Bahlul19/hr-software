...
class LeaveRequestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'available_leave' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'late_apply' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'late_apply' => 1,
                'created' => '2018-07-24 06:18:54',
                'modified' => '2018-07-24 06:18:54'
            ],
        ];
        parent::init();
    }
