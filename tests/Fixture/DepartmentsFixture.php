...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lead' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'no_of_employees' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-17 06:50:10',
                'modified' => '2018-08-17 06:50:10'
            ],
        ];
        parent::init();
    }
