                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <h2 style="font-family: Verdana,Geneva,sans-serif; font-size: 16px;">Hello HR/Reporting Manager of <?= $applierName ?></h2>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 14px; font-family: Verdana,Geneva,sans-serif;">
                        <?= $applierName?> has appiled for <?= $leavesTakenInLast30Days ?> <?= $leave_type ?> in last 30 days </p>
                         <?php if($office_location != "GOA") { ?>
                                <p style="font-weight: bold; font-size: 14px; font-family: Verdana,Geneva,sans-serif;">  
                                  Remaining Sick Leave:  <?= $leavesOfEmployee['sick_taken'] ?><br>
                                  Remaining Earned Leave: <?= $leavesOfEmployee['remainingEarnedLeave'] ?> <br>
                                  Remaining Casual Leave: <?= $leavesOfEmployee['remainingCasualLeave'] ?> <br>
                                </p>
                             <?php }else if($office_location == "GOA") { ?>
                            <p style="font-weight: bold; font-size: 14px; font-family: Verdana,Geneva,sans-serif;">
                                 Remaining Unplanned Leave: <?=  $leavesOfEmployee['remainingUnplannedLeave'] ?> <br>
                                 Remaining Planned Leave: <?=  $leavesOfEmployee['remainingPlannedLeave'] ?> <br>
                                 Remaining Restricted Leave: <?= $leavesOfEmployee['remainingRestrictedLeave'] ?> <br>
                            </p>
                            <?php }?>
                    </td>
                  </tr>
