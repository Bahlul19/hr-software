                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <h2 style="font-family: Verdana,Geneva,sans-serif;">Hi <?= $applierName; ?></h2>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif;">
                        Your leave request for <?=$noOfDays; ?> day/s has been cancelled.
                      </p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                    <!-- <img alt="Leave Denied" height="128" width="128" src="https://connect.managedcoder.com/img/sad.png" style="border-width: 0px; width: 128px; height: 128px;"> -->
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif;">
                        Please consider applying again for some other time.
                      </p>
                    </td>
                  </tr>
                </tbody>
