                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $applierName; ?> Applied Cancellation for Leave <?= $employee_name; ?> no of <span style="color: YellowGreen;"><?=$no_of_days?> day/s</span></h2>
                    </td>
                  </tr>
