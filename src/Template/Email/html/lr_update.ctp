                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <?php if($leaveRequestFrom == '') {?>
                        <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $applierName; ?> Updated the leave <span style="color: YellowGreen;"><?=$no_of_days?> day/s</span></h2>
                      <?php } else { ?>
                        <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $applierName; ?> Updated the leave for <?= $leaveRequestFrom ?> to <span style="color: YellowGreen;"><?=$no_of_days?> day/s</span></h2>
                       <?php }?>
                    </td>
                  </tr>
