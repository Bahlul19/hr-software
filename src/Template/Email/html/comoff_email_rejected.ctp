            ...
            <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#ffffff;">
              ...
              <table style="border-spacing:0;" width="100%">
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif;">
                        Hello <?= $name?>, your compoff request has been cancelled.
                      </p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $applierName ?> cancelled the compoff request of <?= $name?></h2>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif;">
                       Requested Employee name : <?= $name; ?>
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif;"> <span>Request Date: </span>
                        <?= $date; ?>
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif"> <span>Number Hours: </span>
                        <?= $number_of_hours ?>
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif"> <span>PM Name: </span>
                        <?= $pm_name ?>
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif"> <span>Team Name: </span>
                        <?= $team_name ?>
                      </p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif"> <span>Project / Task Details: </span>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif"> <span>Type Of Project: </span>
                        <?= $type_of_project ?>
                      </p>
                    </td>
                  </tr>
