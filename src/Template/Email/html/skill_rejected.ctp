                ...
                <tbody>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                        <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $skillApplier; ?>, Your skill <span style="color: YellowGreen;"><?= $skill?></span> with level <span style="color: YellowGreen;"><?= $level ?></span> was been rejected.</h2>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 16px; font-family: Verdana,Geneva,sans-serif;"> <span>Rejected By: </span>
                        <?= $approver; ?>
                      </p>
                    </td>
                  </tr>
