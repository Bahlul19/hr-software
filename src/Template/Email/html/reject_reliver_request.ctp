                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <?php if($leaveRequestFrom == '') {?>
                        <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $applierName; ?> Rejected the reliver of <?= $employee_name ?> for the leave of <span style="color: YellowGreen;"><?=$no_of_days?> day/s</span></h2>
                      <?php } else { ?>
                        <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $applierName; ?> Rejected the reliver for the leave of <?= $leaveRequestFrom ?> to <span style="color: YellowGreen;"><?=$no_of_days?> day/s</span></h2>
                       <?php }?>
                    </td>
                  </tr>
