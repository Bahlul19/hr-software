                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <h2 style="font-family: Verdana,Geneva,sans-serif;">Hello HR/Reporting Manager of <?= $applierName ?>/<?= $applierName?></h2>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif;">
                          <?php
                            if($office_location == "SYL") { ?>
                                <h3>Hello <?php echo $applierName?></h3>

                                <?php if($sick_leave <= 0) {?>
                                    <h2> Your remainnig sick leave is <?= $sick_leave?> day's </h2><br>
                                <?php } if($casual_leave <= 0) {?>
                                    <h2> Your remainnig casual leave is <?= $casual_leave?> day's </h2><br>
                                <?php } if($earned_leave <= 0) {?>
                                    <h2> Your remainnig earned leave is <?= $earned_leave?> day's </h2><br>
                                <?php } if($planned_leave <= 0) {?>
                                    <h2> Your remainnig planned leave is <?= $planned_leave?> day's </h2><br>
                                <?php } if($unplanned_leave <= 0) {?>
                                    <h2> Your remainnig unplanned leave is <?= $unplanned_leave?> day's </h2><br>
                                <?php } if($restricted_leave <= 0) {?>
                                    <h2> Your remainnig restricted leave is <?= $restricted_leave?> day's </h2><br>
                                <?php } if($lwop_leave_taken >= 20) {?>
                                    <h2> You've taken <?= $lwop_leave_taken?> LWoP day's. You cann't take more than 20 LWoP leave.</h2><br>
                                 <?php }?>
                          <?php } else if($office_location == "GOA") {?>
                                <h3>Hello <?php echo $applierName?></h3>
                                     <?php if($planned_leave <= 0) {?>
                                    <h2> Your remainnig planned leave is <?= ($planned_leave<0) ?  0 :$planned_leave ?> day's </h2><br>
                                <?php } if($unplanned_leave <= 0) {?>
                                    <h2> Your remainnig unplanned leave is <?= ($unplanned_leave<0) ?  0 :$unplanned_leave ?> day's </h2><br>
                                <?php } if($restricted_leave <= 0) {?>
                                    <h2> Your remainnig restricted leave is <?= ($restricted_leave<0) ?  0 :$restricted_leave  ?> day's </h2><br>
                                <?php } if($restricted_leave <= 0) {?>
                                    <h2> You've taken <?= $lwop_leave_taken?> LWoP day's. You cann't take more than 20 LWoP leave.</h2><br>
                                <?php }?>
                          <?php } ?>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                    <!-- <img alt="Leave Approved" height="128" width="128" src="https://connect.managedcoder.com/img/smile.png" style="border-width: 0px; width: 128px; height: 128px;"> -->
                      <p style="font-weight: bold; font-size: 18px; font-family: Verdana,Geneva,sans-serif;">
                        From SJ Innovation, LLC
                      </p>
                    </td>
                  </tr>
                </tbody>
