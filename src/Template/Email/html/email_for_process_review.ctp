                ...
                <table style="border-spacing:0; padding: 5px" width="100%">
                    ...
                    <tr>
                        <td align="center" class="inner heading-table" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                            <h2 style="font-family: Verdana,Geneva,sans-serif;">Processes pending for review for last 3 months</h2>
                        </td>
                    </tr>
                            ...
                            <table style="border-spacing:0; padding: 5px" width="100%">
                                <thead bgcolor="#dddddd">
                                   <th>Id</th>
                                   <th>Process Name </th>
                                   <th>Months since last updated </th>
                                   <th>Created</th>
                                   <th>Modified</th>
                                </thead>
                                <tbody bgcolor="#dddddd"> 
                                    <?php foreach ($processDocumentations as $key => $processDocumentation) { ?>
                                        <tr>
                                                <td><?= $key +1 ?></td>
                                                <td><?= $processDocumentation->title ?></td>
                                                <td><?= $processDocumentation->months < 0 ? ($processDocumentation->months*-1):$processDocumentation->months  ?></td>
                                                <td><?= $processDocumentation->created ?></td>
                                                <td><?= $processDocumentation->modified ?></td>
                                        </tr>
                                   <?php } ?>
                                </tbody>
                            </table>
