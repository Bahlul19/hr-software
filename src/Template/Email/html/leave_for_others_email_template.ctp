                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <h2 style="font-family: Verdana,Geneva,sans-serif;"><?= $employeeWhoAppliedLeaveForOthers; ?> Apply Leave for leave of <?= $LeaveTakenForOthersName ?> <span style="color: YellowGreen;"><?=$no_of_days?> day/s</span></h2>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 16px; font-family: Verdana,Geneva,sans-serif;"> <span>Date: </span>
                        <?=date('D, jS M, Y', strtotime($date_from)); ?> to <?=date('D, jS M, Y', strtotime($date_to)); ?>
                      </p>
                    </td>
                  </tr>
                  ...
                  <!-- Formal reason for the leave. -->
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 16px; font-family: Verdana,Geneva,sans-serif;"> <span>Reason: </span>
                        <?=$leave_reason ?>
                      </p>
                    </td>
                  </tr>
                  ...
                  <!-- Leave approve or reject button -->
                  <tr>
                    <td class="inner contents center" style="padding-top:15px;padding-bottom:50px;padding-right:0px;padding-left:0px;text-align:center;">
                      <center>
                        ...
                        <span class="sg-image" data-imagelibrary="%7B%22width%22%3A%22260%22%2C%22height%22%3A54%2C%22alt_text%22%3A%22Reset%20your%20Password%22%2C%22alignment%22%3A%22%22%2C%22border%22%3A0%2C%22src%22%3A%22https%3A//marketing-image-production.s3.amazonaws.com/uploads/c1e9ad698cfb27be42ce2421c7d56cb405ef63eaa78c1db77cd79e02742dd1f35a277fc3e0dcad676976e72f02942b7c1709d933a77eacb048c92be49b0ec6f3.png%22%2C%22link%22%3A%22%23%22%2C%22classes%22%3A%7B%22sg-image%22%3A1%7D%7D">
                            <?php
                            echo $this->Html->link(
                                //$this->Html->image($imageUrl, ['style' => 'border-width: 0px; margin-top: 30px; margin-bottom: 50px; width: 260px; height: 54px;" width="260', "height" => "54", "alt" => "Approve/Deny Leave Request"]),
                                'Approve/Deny Leave Request',
                                ['controller' => 'emp-leaves', 'action' => 'view/' . $leaveId, '_full' => true],
