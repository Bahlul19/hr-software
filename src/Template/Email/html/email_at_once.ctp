                ...
                <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#ffffff;">
                    ...
                    <div style="margin-bottom: 10px; border: 1px solid #000000">
                        <table style="border-spacing:0; padding: 5px" width="100%">
                            ...
                            foreach ($totalLeavesFromSyl as $leave)
                            {
                                ...
                                $dateFrom = $leave->min_date;
                                $dateTo = $leave->max_date;
                                ?>
                    ...
                    <div style="margin-bottom: 10px; border: 1px solid #000000">
                        <table style="border-spacing:0; padding: 5px" width="100%">
                            ...
                            <tr>
                                <td align="center" class="inner heading-table" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                                    <h2 style="font-family: Verdana,Geneva,sans-serif;">Yesterday's total leave from Sylhet : <span style="color: YellowGreen;"><?=$totalLeavesFromSylCountYesterday?></span></h2>
                                </td>
                            </tr>

                            <?php
                            foreach ($totalLeavesFromSylYesterday as $leave)
                            {
                                $employeeName = $leave->employee_name;
                                $dateFrom = $leave->min_date;
                                $dateTo = $leave->max_date;
                    ...
                    <div style="margin-bottom: 10px; border: 1px solid #000000">
                        <table style="border-spacing:0; padding: 5px" width="100%">
                            ...
                            <tr>
                                <td align="center" class="inner heading-table" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                                    <h2 style="font-family: Verdana,Geneva,sans-serif;">Yesterday's total leaves from Dhaka : <span style="color: YellowGreen;"><?=$totalLeavesFromDhkCountYesterday?></span></h2>
                                </td>
                            </tr>

                            <?php
                            foreach ($totalLeavesFromDhkYesterday as $leave)
                            {
                                $employeeName = $leave->employee_name;
                                $dateFrom = $leave->min_date;
                                $dateTo = $leave->max_date;
                    ...
                    <div style="margin-bottom: 10px; border: 1px solid #000000">
                        <table style="border-spacing:0; padding: 5px" width="100%">
                            ...
                            <tr>
                                <td align="center" class="inner heading-table" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                                    <h2 style="font-family: Verdana,Geneva,sans-serif;">Yesterday's total leave from Goa : <span style="color: YellowGreen;"><?=$totalLeavesFromGoaCountYesterday?></span></h2>
                                </td>
                            </tr>

                            <?php
                            foreach ($totalLeavesFromGoaYesterday as $leave)
                            {
                                $employeeName = $leave->employee_name;
                                $dateFrom = $leave->min_date;
                                $dateTo = $leave->max_date;
                    ...
                    <div style="margin-bottom: 10px; border: 1px solid #000000">
                        <table style="border-spacing:0; padding: 5px" width="100%">
                            ...
                            <tr>
                                <td align="center" class="inner heading-table" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                                    <h2 style="font-family: Verdana,Geneva,sans-serif;">Yesterday's total leave from Newyork : <span style="color: YellowGreen;"><?=$totalLeavesFromNycCountYesterday?></span></h2>
                                </td>
                            </tr>

                            <?php
                            foreach ($totalLeavesFromNycYesterday as $leave)
                            {
                                $employeeName = $leave->employee_name;
                                $dateFrom = $leave->min_date;
                                $dateTo = $leave->max_date;
                    ...
                    <div style="margin-bottom: 10px; border: 1px solid #000000">
                        <table style="border-spacing:0; padding: 5px" width="100%">
                            ...
                            <tr>
                                <td align="center" class="inner heading-table" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                                    <h2 style="font-family: Verdana,Geneva,sans-serif;">Yesterday's total leave from Ukraine : <span style="color: YellowGreen;"><?=$totalLeavesFromUkrCountYesterday?></span></h2>
                                </td>
                            </tr>

                            <?php
                            foreach ($totalLeavesFromUkrYesterday as $leave)
                            {
                                $employeeName = $leave->employee_name;
                                $dateFrom = $leave->min_date;
                                $dateTo = $leave->max_date;
