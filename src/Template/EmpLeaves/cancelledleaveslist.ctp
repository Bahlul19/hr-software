                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th scope="col"><?= $this->Paginator->sort('reliever_status','Reliever Status'); ?></th>
                            <th scope="col"><?= $this->Paginator->sort('emp_leave_cancellation','Status');?></th>
                                ...
                                <td><?php
                                    ...
                                    <td><?php
                                        if($leaveRequest->reliever_status == 0){
                                            echo "Pending";
                                        } elseif ($leaveRequest->reliever_status == 1){
                                            echo "Approved";
                                        } elseif($leaveRequest->reliever_status == 2) {
                                            echo "Rejected";
                                        } else {
                                            echo "Cancelled";
                                        }
                                    ?></td>
                                    <td><?php
                                        if($leaveRequest->emp_leave_cancellation == 0){
                                            echo "Pending";
                                        } elseif ($leaveRequest->emp_leave_cancellation == 1){
                                            echo "Cancelled";
                                        } else {
                                            echo "Please Contact With HR";
                                        }
                                    ?></td>
