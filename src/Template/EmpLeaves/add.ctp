                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <label for="">Total Leave Taken&nbsp;&nbsp;&nbsp;   </label>
                                <div class="form-group">
                                    <?php
                                        echo $this->form->text('',['class' => 'form-control','readonly'=>'true','value' => $totalLeaveTaken]);
                                    ?>
                                </div>
                            </div>                                      
                        </div>
                        ...
                        <div class="row">
                            ...
                            <label for="">LWoP Leave Taken</label>
                                <div class="form-group">
                                    <?php
                                        echo $this->form->text('',['class' => 'form-control','readonly'=>'true','id'=>'lwopTaken','placeholder' => $LWoP_taken]);
                                    ?>
                                </div>
                            </div> 
                            <div class="col-md-6">
