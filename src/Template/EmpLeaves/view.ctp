            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <?php 
                                  if(!empty($dateAndDays))
                                  {
                                    $min_date= $dateAndDays->min_date;
                                    $max_date= $dateAndDays->max_date;
                                    $number_of_days= $dateAndDays->no_of_days;
                                  }else 
                                    {
                                        $min_date= $leaveRequest->date_from;
                                        $max_date= $leaveRequest->date_to;
                                        $number_of_days=$leaveRequest->no_of_days;                                           
                                    }
                            ?>
                            <label class="control-label">Date From: </label>
                            <?php 
                                echo date('m/d/Y',strtotime(h($min_date)));
                            ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php
                            echo date('m/d/Y',strtotime(h($max_date)));
                            ?>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            foreach ($relieverList as $rl) :
                                if($rl != "") {
                                    if ($cnt == 0) {
                                        echo "<p style='font-size: 16px; display: inline'>" . $this->Html->link(\App\Model\Table\EmpLeavesTable::getEmployeeNameFromId($rl), ['controller' => 'Employees', 'action' => 'view', $rl]) . "</p>";
                ...
                <div class="form-actions">
                    ...
                    <?php    echo $this->Html->link(
                            __('Approve'),
                            ['action' => 'approve',1,$ids,$leaveRequest->employee_id,$leaveRequest->leave_type,$leaveRequest->half_day], ['class' => 'btn btn-success']
                        ); ?>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <?php echo $this->Form->create($leaveRequest, ['url' => ['action' => 'rejectReason',2,$ids,$leaveRequest->employee_id,$leaveRequest->leave_type,$leaveRequest->half_day]]) ?>
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
