...
<div class="card-header" style="width: 100%; text-align: center; background-color: #E95131; margin-top: 10px; margin-bottom: 20px">
    <h2 class="m-b-0" style="color: #ffffff">Your remaining CompOff request approved hour: <span id="remainingHours"><?= $approvedHour;?></span> hours</h2>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="input text required" id="available-compoff">
                            <label class="control-label" for="dateFrom">Remaining approved CompOff hours</label>
                            <input type="text" name="date" class="form-control" readonly value="<?=$approvedHour;?>">
                        </div>
                    </div>
                </div>
            </div>
