    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white">Update Leave Days for <?= $employeeName?></h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo $this->Form->control('planned_leave', [
                                        'label' => [
                                            'text'=>'Rem. Planned Leave Balance',
                                            'class' => 'control-label'
                                        ],
                                        'class'=>'form-control',
                                        'id'=>'planned-leave'
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo $this->Form->control('unplanned_leave', [
                                        'label' => [
                                            'text'=>'Rem. Unplanned Leave Balance',
                                            'class' => 'control-label'
                                        ],
                                        'class'=>'form-control',
                                        'id'=>'unplanned-leave'
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo $this->Form->control('restricted_leave', [
                                        'label' => [
                                            'text'=>'Rem. Restricted Leave Balance',
                                            'class' => 'control-label'
                                        ],
                                        'class'=>'form-control',
                                        'id'=>'restricted-leave'
                ...
                <?php
                    ...
                    echo $this->Form->text('updated_by', [
                            'label' => [
                                'class' => 'control-label'
                            ],
                            'class'=>'form-control',
